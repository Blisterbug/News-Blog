  ...
  return (
    ...
    <div className='grid grid-cols-3 gap-6 p-8'>
        ...
        <div className=' flex justify-between'>
                    <div className='pl-20'>
                        <BigCard queryParameter="Weather"/>
                    </div>
                    <div className='pr-16'>
                        <BigCard queryParameter="Weather"/>
                    </div>
        ...
        <h2 className="text-3xl font-bold  p-4 pb-6 pl-24 pt-12">Recent Trending on World Weather</h2>
        {/* Recent trending on this category  */}
        <div className='w-full'>
        <div className='grid grid-cols-3 gap-4 p-8 pl-24'>
            <Card queryParameter="Weather"/> 
            <Card queryParameter="Weather"/> 
            <Card queryParameter="Weather"/> 
        </div>
        </div>

        <LoadMore title="Weather"/>
        <Footer/>
    </div>
    </div>
  )
