  ...
  return (
    ...
    <div className='grid grid-cols-3 gap-6 p-8'>
        ...
        <div className=' flex justify-between'>
                    <div className='pl-20'>
                        <BigCard queryParameter="business"/>
                    </div>
                    <div className='pr-16'>
                        <BigCard queryParameter="business"/>
                    </div>
        ...
        <h2 className="text-3xl font-bold  p-4 pb-6 pl-24 pt-12">Recent Trending on World Business</h2>
